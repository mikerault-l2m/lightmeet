    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorie', models.CharField(choices=[('Généraliste', 'Site généraliste'), ('Libertin', 'Site libertin'), ('Senior', 'Site senior'), ('Extra-conjugales', 'Site extra-conjugal'), ('Haut-de-gamme', 'Site haut-de-gamme')], default='Généraliste', max_length=25)),
